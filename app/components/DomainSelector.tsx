...
export default function DomainSelector({ selectedDomains, toggleDomain }: DomainSelectorProps) {
  return (
    <div className="relative w-full max-w-sm bg-white shadow-[0_8px_10px_rgba(0,0,0,0.25),0_10px_20px_rgba(0,0,0,0.15)] rounded-sm p-8 md:p-10 tab-noise transform rotate-1 border border-gray-100">
