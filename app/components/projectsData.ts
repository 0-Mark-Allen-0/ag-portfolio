...
- using the generated mesh`,
  ...
  },
  {
    ...
    title: "SpellFast",
    rotation: "-rotate-1",
    synopsis: "An arcade-style educational spelling game built for custom school kiosks across Tamil Nadu, featuring fast-paced gameplay and local score tracking.",
    description: `An educational game application created for arcade-game kiosks (hardware made in collaboration with a friend’s company) placed at schools across Tamil nadu. As the name suggests, it is a quick spelling-game that keeps and displays scores for gameplays like old-school Tetris-like arcades.`,
    link: "#",
    tags: ["Interactive Experience", "Explain an Idea", "Education", "Real-Time System"],
    type: "Game-Related",
    importance: 1,
    imageUrl: "/images/projects/spellfast.webp",
    links: [
      "https://github.com/adharshg/virtual-ot",
      "https://example-demo.vercel.app/virtual-ot",
      "https://vifrtech.com/virtual-ot",
...
Separate clips for Face-tracking and the motion-capture for the bodies were shot and blended together since we could not 3D-print the face-rigs within the time limit. Despite that, the result came out as expected.`,
  ...
  {
    id: "heka-ux",
    title: "Heka - Android App UX",
    rotation: "rotate-1",
    synopsis: "A rapid Unity prototype for a 3D interactive companion app featuring immersive navigation and UX for an educational robotics product.",
    description: `Created a quick prototype of a set of features for a 3D-interactive companion application of a robotics startup’s educational product. This meant it needed to have a virtual navigation scene, an immersive UX-flow for the menus.`,
    link: "#",
    tags: ["Explain an Idea", "Real-Time System", "Prototype Concept", "UX Design", "Product Prototype", "3D Environment"],
    type: "Graphic Design",
    importance: 2,
    imageUrl: "/images/projects/heka-app.webp",
  },
  {
